...
* [III. 核心技术](III. Core Technologies/README.md)
  * [7.IoC 容器](III. Core Technologies/7. The IoC container.md)
    ...
    * [7.13. 环境的抽象](III. Core Technologies/7.13. Environment abstraction.md)
      ...
      * [7.13.2 xml的bean定义profile](III. Core Technologies/7.13.2. PropertySource abstraction.md)
      * [7.13.3 PropertySource抽象](III. Core Technologies/7.13.3. @PropertySource.md)
      * [7.13.4 @PropertySource](III. Core Technologies/7.13.4. Placeholder resolution in statements.md)
  ...
  * [8. Resources](III. Core Technologies/6. Resources.md)
    * [8.1. Introduction](III. Core Technologies/6.1. Introduction.md)
    * [8.2. The Resource interface](III. Core Technologies/6.2. The Resource interface.md)
    * [8.3. Built-in Resource implementations](III. Core Technologies/6.3. Built-in Resource implementations.md)
    * [8.4. The ResourceLoader](III. Core Technologies/6.4. The ResourceLoader.md)
    * [8.5. The ResourceLoaderAware interface](III. Core Technologies/6.5. The ResourceLoaderAware interface.md)
    * [8.6. Resources as dependencies](III. Core Technologies/6.6. Resources as dependencies.md)
    * [8.7. Application contexts and Resource paths](III. Core Technologies/6.7. Application contexts and Resource paths.md)
